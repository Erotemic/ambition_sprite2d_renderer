"""The Director's held pen, as SVG paths in root user units.

⛔⛔ IT WAS ONLY EVER IN THE GENERATED RIG. `build_director` authored a SWORD --
the one he put down in "The Director puts down the sword and picks up the pen" --
