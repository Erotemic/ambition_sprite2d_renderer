...
ACTOR_METADATA = {
    "actor": {"character_id": "npc_pirate_raider", "display_name": "Pirate Raider"},
    "body": {
        "body_plan": "HumanoidBiped",
        "body_kind": "Standard",
        "mass_class": "Medium",
        "traits": ["story", "humanoid", "enemy", "combatant", "pirate", "raider"],
    ...
    "tags": ["story", "humanoid", "enemy", "combatant", "pirate", "raider"],
    "sockets": {
        "head": {
...
def render_portraits(out_dir: str | Path, **opts):
    ...
    """
    return render_pirate_portraits("pirate_raider", out_dir, quality_scale=opts.get("quality_scale"), kind="pirate_raider")
