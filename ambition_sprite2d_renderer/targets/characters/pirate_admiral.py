...
ACTOR_METADATA = {
    "actor": {"character_id": "npc_pirate_admiral", "display_name": "Pirate Admiral"},
    "body": {
...
def render_portraits(out_dir: str | Path, **opts):
    ...
    """
    return render_pirate_portraits("pirate_admiral", out_dir, quality_scale=opts.get("quality_scale"), kind="pirate_admiral")
