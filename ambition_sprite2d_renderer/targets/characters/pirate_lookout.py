...
ACTOR_METADATA = {
    "actor": {"character_id": "npc_pirate_lookout", "display_name": "Pirate Lookout"},
    "body": {
...
def render_portraits(out_dir: str | Path, **opts):
    ...
    """
    return render_pirate_portraits("pirate_lookout", out_dir, quality_scale=opts.get("quality_scale"), kind="pirate_lookout")
